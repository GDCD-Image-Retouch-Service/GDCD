...
public interface CommentRepository extends MongoRepository<Comment, Long> {
    ...
    List<Comment> findAllByPostIdAndUpperAndValidationOrderByRegistDateDesc(Long postId, Long upper, boolean validation);

    List<Comment> findAllByUpperAndValidation(Long upper, boolean validation);
    List<Comment> findAllByUpperAndValidationOrderByRegistDateDesc(Long upper, boolean validation);
