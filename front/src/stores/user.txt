...
export const useUserStore = defineStore('userStore', {
  state: () => ({
    ...
    // 토큰
    token:
      'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0amRlanIzMzdAZ21haWwuY29tIiwiaWF0IjoxNjY0MTczNTMzLCJleHAiOjE2NjQxOTE1MzN9.badqsflSiRnpha6TfeVWzVxx8a1ftwrJFkg1tPTBcbA', // 로그인한 유저 정보
    currentUserInfo: {},
